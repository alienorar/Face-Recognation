    ...
    <Layout>
      <Sider trigger={null} collapsible collapsed={collapsed} width={260}>
        ...
        <div className='flex p-4 gap-2 font-semibold mb-2'>
          <img src={MainLogo} alt="main-logo" className='w-[40px] h-[40px] ' />
          {
            !collapsed && (<span className='text-[20px] text-[#fff] flex'>Teacher Panel</span>)
          }
        </div>
      ...
      <Modal
        ...
        cancelText="Cancel"
        okButtonProps={{
          style: { backgroundColor: '#58e842', borderColor: '#58e842', color: '#fff', marginLeft: 10, padding: 4 },
        }}
      >
